...
FILES=(
    "${DEPLOY_DIR}/bootstrap.sh" "${DEPLOY_DIR}/logrotate-nginx.conf" "${DEPLOY_DIR}/install.sh" "${DEPLOY_DIR}/post-receive" "${DEPLOY_DIR}/spup.service" "${DEPLOY_DIR}/nftables.conf"

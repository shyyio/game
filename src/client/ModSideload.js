...
//
// The URLs are whatever the player asked for, and a mod is untrusted code running in this page,
// which is why the client shows where it loaded from.
...
/**
 * The package base URLs the current location asks for.
 * @returns {string[]}
 */

...
/**
 * The optional sim part of a mod: bespoke ECS content registered on the engine. A sim mod registers
 * components (engine.components.register) and systems (engine.registerSystem), which carry its tick
 * passes, message handling, chunk sync and inspection.
 */

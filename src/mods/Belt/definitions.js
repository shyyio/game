...
// Placeable-object definitions contributed by the Belt mod (ports, footprint,
// and the per-tick SQL ops that advance items along each belt path).
export const beltDefinitions = {
